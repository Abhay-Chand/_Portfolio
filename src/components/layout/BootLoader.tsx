...
export function BootLoader({ onComplete, version = 'PORTFOLIO OS v1.0.0' }: BootLoaderProps) {
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        <div
          style={{
            ...
            background: 'linear-gradient(135deg, #38bdf8, #06b6d4, #818cf8)',
      ...
      <div
        style={{
          ...
          boxShadow: '0 0 50px rgba(56,189,248,0.07)',
        }}
      >
      ...
      <div style={{ width: 'min(480px, 88vw)', marginTop: '1rem' }}>
        ...
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.58rem', color: 'rgba(56,189,248,0.35)', textAlign: 'right', marginTop: '0.3rem' }}>
          {Math.round(progress)}%
        </div>
      </div>
    </div>
